function AddFuelRow(e) {
    ...
    ValidateJurisdictionBeforeAddRow(JurisdictionInput, RowId)
        .then(function (IsValidJurisdiction) {
...
function GetListOfFuelDetail() {
    ...
    for (var i = 0; i < totalData; i++) {
        fuelDetail.push({
            ...
            'StateProvince': table.find('tbody#FuelData input[name="FuelList[' + i + '].Jurisdiction"]').val(),
            'StateProvinceId': table.find('tbody#FuelData input[name="FuelList[' + i + '].JurisdictionId"]').val(),
