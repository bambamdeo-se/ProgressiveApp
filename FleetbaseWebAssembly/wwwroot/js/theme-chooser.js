(function() {
    ...
    $(document).ready(function() {
        if (Cookies.get("Theme") != null && Cookies.get("Theme") != "") {
            window.kendoThemeChooser.changeTheme(Cookies.get("Theme"), true);
        }
    });
    ...
    var ThemeChooserViewModel = kendo.observable({
        themes: [
            { value: "necs1", name: "NECS 1", colors: ["#298bc8", "#515967", "#eaeaec"] },
