...
$.ajaxExt = function (parameters) {
    ...
    function onSuccess(data, parameters) {
        ...
        if (data.Status == ActionStatus.Error) {
            if (parameters.successServerError != undefined && parameters.successServerError != null)
                parameters.successServerError(data);
    ...
    if (parameters.forPopup == true && parameters.html != "" && parameters.html != undefined) {
        ...
        if (parameters.containFiles == true) {
            ...
            $(parameters.formToPost).ajaxSubmit({
                ...
                beforeSubmit: function () { if (parameters.beforeSubmit != undefined && parameters.beforeSubmit != null) beforeSubmit(); $.ShowThrobber(parameters.throbberPosition, parameters.throbberCenter); },  // pre-submit callback
            ...
            var request = $.ajax({
                ...
                error: function (a, b, c) { $('#lightbox_overlay').hide(); $('body').addClass('SetOverflow'); onError(a, b, c, parameters); },
                success: function (data) { $('#lightbox_overlay').hide(); $('body').addClass('SetOverflow'); onSuccess(data, parameters); }
            });
